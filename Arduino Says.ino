...
const int led1 = 0;
const int Trigger2 = 11;   //Pin digital 2 para el Trigger del sensor
const int Echo2 = 6;
const int led2 = 3;
const int Trigger3 = 12;   //Pin digital 2 para el Trigger del sensor
const int Echo3 = 7; 
const int led3 = 4;
const int Trigger4 = 13;   //Pin digital 2 para el Trigger del sensor
const int Echo4 = 8;
const int led4 = 9;
const int buzzer = 2;
